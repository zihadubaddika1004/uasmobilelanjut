...
class tanyaDokterUmum extends StatefulWidget {
  @override
  _tanyaDokterUmumPageState createState() => new _tanyaDokterUmumPageState();
}

class _tanyaDokterUmumPageState extends State<tanyaDokterUmum> {
  String pertanyaan, lama_gejala;
  var validate = false;
  ...
  submit() async {
    final response = await http.post("http://redigo-api.000webhostapp.com/tanya.php", body: {
